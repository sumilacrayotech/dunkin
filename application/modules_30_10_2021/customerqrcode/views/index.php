...
<section class="content-header">
    <h1>
        Manage Customer Qrcode
        <small>Manage Customer Qrcode Here</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url().'dashboard';?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Customer Qrcode List</li>
    </ol>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Customer Qrcode List</h3>
            <div class="box-tools pull-right" style="display: inline-block !important;">
                ...
                <!--<a href="<?php //echo base_url('voucher/uploadsharedata') ?>" class="search_clear" style="margin-top: 1px;float: left;padding: 3px 8px 3px 8px;"> <i class="fa fa-download" aria-hidden="true"></i> Upload & Share Customer Qrcode </a>-->
            </div>
        </div>
        <div class="box-body">
            <?php echo $output; ?>
...
<form method="post" action="<?php echo base_url('customerqrcode/exportCSV') ?>">
