                    ...
                    <form method="post" action="<?php echo base_url();?>questions/addquestionsprocess">
                        ...
                        <div id="addoptions" style="display: none;">
                            <div class="form-group">
                                ...
                                <br>
                                <input type="text" class="form-control form_inputnew" placeholder="Text Here" name="answeropt[]" id="" style="width:45%">
                                <input type="text" class="form-control form_inputnew" placeholder="Arabic Text Here" name="answeroptarabic[]" id="" style="width:45%" >
                            </div>
