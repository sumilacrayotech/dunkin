...
?>
                        ...
                        <div class="form-group"><input type="text" class="form-control form_inputnew" value=<?php echo $options[$i];?> placeholder=" Text Here"  required="" name="answeropt[]" /> <a href="javascript:void(0);" class="remove_field1">Remove</a></div>
                            <?php } ?>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        <?php if (($questdt->category=='checkbox') || ($questdt->category=='radiobutton')){?>
        $('#addoptions').show();
        <?php } else {?>
        $('#addoptions').hide();
        <?php } ?>
...
//- Using an anonymous function:
        ...
        $(add_button).click(function(e){
            ...
            if(x < max_fields){
                ...
                //add input field
                $(wrapper).append('<div class="form-group"><input type="text" class="form-control form_inputnew"  placeholder=" Text Here"  required="" name="answeropt[]" /> <a href="javascript:void(0);" class="remove_field">Remove</a></div>');
            }
        });
