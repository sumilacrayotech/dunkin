...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100 p-l-50 p-r-50 p-t-30 p-b-30">
            <div class="top_cssdiv"> <div class="left_div"> </div><div class="right_div"> <a href="<?php echo base_url() ?>frontend/signup/<?php echo $this->uri->segment(3);?>" class="lang_menu mob_lan"> <i class="fa fa-globe" aria-hidden="true"></i> English </a> </div> </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="wrap-input100 m-b-10" >
                            ...
                            <input class="input100" type="text" name="emailid" placeholder="أدخل الاسم" required="">
                            <div class="line"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="wrap-input100  m-b-10" >
                            ...
                            <input class="input100" type="text" name="customername" placeholder="أدخل البريد الإلكتروني" required>
                            <div class="line"></div>
