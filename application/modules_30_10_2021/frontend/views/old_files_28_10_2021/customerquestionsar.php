...
<div class="limiter">
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-30 p-b-30">
            <div class="top_cssdiv"> <div class="left_div"><!--<a href="index.html"> <i class="fa fa-angle-left" aria-hidden="true"></i> Back</a>--> </div><div class="right_div"> <a href="<?php echo base_url();?>frontend/ar" class="lang_menu mob_lan"> <i class="fa fa-globe" aria-hidden="true"></i> العربية </a> </div> </div>
