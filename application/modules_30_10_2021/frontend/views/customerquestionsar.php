<div class="limiter">
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-30 p-b-30">
            <div class="top_cssdiv"> <div class="left_div"> </div><div class="right_div"> <a href="<?php echo base_url();?>frontend/custlistmainquestions/<?php echo $this->uri->segment(3);?>/<?php echo $qtid;?>" class="lang_menu mob_lan"> <i class="fa fa-globe" aria-hidden="true"></i> English </a> </div> </div>
            ...
            <br>	<br>
            <form class="login100-form validate-form " method="post" action="<?php echo base_url();?>frontend/customerquestionsprocessar">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="wrap-input100 m-b-10" >
                            <h5 class="m-b-15"><?php echo $qt->questiontitlearabic;?></h5>
