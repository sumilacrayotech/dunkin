...
$data=array('noofstars'=>$hidrating,'storeid'=>$storeid,'custinput'=>$inputopt,'questiontitle'=>$questtitle,'answer'=>$answer,'category'=>$category,'custansweroptions'=>$jsonData,'answeroptions'=>$jsonDataall,'questionnaireid'=>$questionnaireid,'customerid'=>$customerid,'questid'=>$questid);
            $app  =  new App();
...
redirect("frontend/success/$questionnaireid/$hidqrcode");
 ...
 $this->db->where('questionnaireid',$questionnaireid);
          ...
          $data=array('noofstars'=>$hidrating,'arabic'=>1,'custinput'=>$inputopt,'questiontitle'=>$questtitle,'answer'=>$answer,'category'=>$category,'custansweroptions'=>$jsonData,'answeroptions'=>$jsonDataall,'questionnaireid'=>$questionnaireid,'customerid'=>$customerid,'questid'=>$questid);
          $app  =  new App();
          $insertquest=$app->insertcustomerquestions($data);
