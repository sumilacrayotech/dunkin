...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Create Designer</li>
    </ol>
</section>
<section class="content">
    <div id="message_designer" style="margin: 0px 0px 11px 0px;"></div>
    <form method="POST" action="" id="user_register_designer">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" tabindex="1" required name="brand_name" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
