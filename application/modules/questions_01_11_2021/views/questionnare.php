...
<div class="content-wrapper" style="min-height: 525px;">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Add Questionnare</li>
        </ol>
    </section>
        ...
        <div class="box_new">
            <div class="row">
                  <div class="col-lg-12 col-xs-12">
                        <h4><strong>Questionnare</strong></h4>
                   <br>
                  </div>
                   <form method="post" action="<?php echo base_url();?>questions/mainquestionprocess">
                ...
                <div class="col-lg-4 col-xs-12">
                    <span style="color:green;font-size:18px;"><?php echo $this->session->flashdata('messages');?></span>
                        ...
                        <input type="text" class="form-control  " placeholder="" name="title" id=""  required>
                        </div>
                    <div class="form-group">
                        <label for="username">Arabic Title</label>
                        <input type="text" class="form-control  " placeholder="" name="titlearabic" id=""  required>
                    </div>
