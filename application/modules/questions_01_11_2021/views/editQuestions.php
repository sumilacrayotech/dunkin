...
<?php //}?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="type" required>
                                <option value="">Please Select</option>
                                <option value="Mandatory" <?php if ($questdt->status=='Mandatory'){?>selected <?php };?>>Mandatory</option>
                                <option value="Optional" <?php if ($questdt->status=='Optional'){?>selected <?php };?>>Optional</option>
                            </select>
                        </div>
