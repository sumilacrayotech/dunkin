...
<head>
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-60125d949e329b0c"></script>
    <!-- Latest jQuery -->
    <script src="<?php echo $main->skinFront('js/jquery-1.12.4.min.js')?>"></script>
    <script>
        var base_url = '<?php echo base_url() ?>';
    </script>
    <script src="<?php echo $main->skinFront('js/jquery.validate.js')?>"></script>
    <script src="<?php echo $main->skinFront('js/customer.js')?>"></script>
    <style>
        .error {
            color: red;
        }
