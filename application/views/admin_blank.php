...
<head>
    ...
    <link href="<?php echo $admin->skin('css/jquery.tagit.css');?>" rel="stylesheet" type="text/css">
    <link href="<?php echo $admin->skin('css/tagit.ui-zendesk.css');?>" rel="stylesheet" type="text/css">
...
<script src="<?php echo $admin->skin('js/tag-it.js');?>" type="text/javascript" charset="utf-8"></script>
</body>
<script>
    ...
    function createTag()
    {
        var inp=prompt('Enter a product name');$('#methodTags').tagit('createTag', inp);return false;
    }
</script>
</html>
