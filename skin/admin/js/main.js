...
var baseurl = base_url(1).split('index.php/');
//------------- Modernizr -------------//
//load some plugins only if is needed
Modernizr.load({
  test: Modernizr.placeholder,
  //nope: baseurl+'plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  //yep: [baseurl+'plugins/fix/ios-fix/ios-orientationchange-fix.js', baseurl+'plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
