...
<div class="flexigrid crud-form" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	<div class="mDiv">
		<div class="ftitle gc-srch-rslt-hdwrap">
			<div class='ftitle-left gc-srch-rslt-head'>
				<?php echo $this->l('list_record'); ?> <?php echo $subject?>
			</div>
			<div class='clear'></div>
		</div>
		<div title="<?php echo $this->l('minimize_maximize');?>" class="ptogtitle gc-srch-rsrt-shhdbt">
			<span></span>
            show/hide
		</div>
	</div>
<div id='main-table-box'>
	...
	<div class="pDiv srchrslt-btbutwrap">
